package com.gag.common.util;

import com.alibaba.fastjson.JSONObject;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.gag.common.entity.CurrentUser;
import com.gag.common.entity.GaGAuthUser;
import com.gag.common.entity.constant.RegexpConstant;
...
public class GaGUtil {
    ...
    public static String getCurrentUsername() {
        ...
        if (principal instanceof GaGAuthUser) {
            return ((GaGAuthUser) principal).getUsername();
        }
